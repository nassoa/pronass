  ...
  const experiences = [
    {
      ...
      title: "Développeur Front-End Senior - Fluentech",
      description:
        "Création d'interfaces web fluides (SPA/SSR) avec Next.js App Router et React.js. Architecture scalable (atomic design, monorepo), Design Systems (Storybook, Tailwind), optimisation web (A11y, Core Web Vitals), et intégration d'API (REST/GraphQL). Réalisations : migration d'applications vers Next.js, conception de dashboards avec D3.js, et collaborations design pixel-perfect.",
      tags: [
        "React.js",
        "Next.js",
        "TypeScript",
      ...
      link: "https://www.fluentech-group.com/",
    },
    {
      date: "2022 - 2025",
    ...
    },
    {
      ...
      description:
        "Intégration de maquettes responsives et mobile-first, en respectant les standards web. Développement d'applications React.js/Redux avec Gatsby.js pour des solutions robustes (JAMstack) et SEO-friendly, incluant la création de blogs dynamiques via GraphQL. Expertise en optimisation technique et accessibilité, alignée aux besoins clients pour des livrables sur mesure.",
      tags: [
        "React.js",
        "Next.js",
        "TypeScript",
